...
I learned about the homies and the three amigos and what they're used for as well as the express router for organising routes.

- [x] Describe Middleware?

Middleware functions are functions that have access to the homies (req/res), and the next middleware function in the application’s request-response cycle (via next). They can execute or change any code before moving to the next middleware function, or end the request-response cycle.

- [x] Describe a Resource?

A resource is some type of data the backend API is sending back to the client upon a successful request. A list of posts and users, for instance.

- [x] What can the API return to help clients know if a request was successful?

HTTP codes in the 200s represent successful request operations.

- [x] How can we partition our application into sub-applications?

We can use express routers to separate routes into their own files/folders.
